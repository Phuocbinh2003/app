  ...
  st.title("Ứng dụng xử lý ảnh")
    ...
    if uploaded_file:
        ...
        option = st.sidebar.selectbox(
            "Chức năng",
            ["Lật ảnh", "Xoay ảnh", "Chuyển đổi không gian màu", "Cắt ảnh", "Dịch ảnh"],
        )
        ...
        elif option == "Chuyển đổi không gian màu":
            st.header("Chuyển đổi không gian màu")
