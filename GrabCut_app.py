...
def get_image_with_canvas(image):
    ...
    <div style="position: relative;">
        ...
        <canvas id="canvas" width="{width}" height="{height}" style="position: absolute; top: 0; left: 0; z-index: 5; border: 1px solid red;"></canvas>
        <div id="rectInfo" style="margin-top: 10px; font-size: 16px; color: black; background: rgba(255, 255, 255, 0.8); padding: 10px; border: 1px solid #ccc; border-radius: 5px; position: relative; z-index: 15;"></div>
    </div>
    <script>
