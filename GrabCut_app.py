...
def get_image_with_canvas(image):
    ...
    <div style="position: relative;">
        ...
        <div id="rectInfo" style="margin-top: 10px; font-size: 16px; color: black; background: rgba(255, 255, 255, 0.8); padding: 10px; border: 1px solid #ccc; border-radius: 5px; width: 100%;"></div>
    </div>
    <script>
