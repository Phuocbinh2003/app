...
# Hàm để resize ảnh sao cho chiều cao của chúng bằng n
...
def run_app2():
    ...
    st.header("2. Các bước của Watershed")
    ...
    distance_thresh_factor = st.sidebar.slider("Ngưỡng Distance Transform", min_value=0.1, max_value=1.0, value=0.1, step=0.1)
